...
def process_sentence(s):
    '''
    remove other chars and lowercase the sentence.
    '''
...
def readLangs(lang1, lang2, reverse=False):
    '''
    read data file and get pairs of Kiswahili-Kikuyu translation
    '''
...
def filterPair(p):
    '''drop data if len of words is more than MAX_LENGTH'''
    MAX_LENGTH = 25
...
def main():
    input_lang, output_lang, pairs = prepareData('kiswahili', 'kikuyu')
